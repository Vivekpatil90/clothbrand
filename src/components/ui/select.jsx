...
(({ className, ...props }, ref) => (
  React.createElement(SelectPrimitive.ScrollUpButton, {
    ...
    , React.createElement(ChevronUp, { className: "h-4 w-4" , __self: this, __source: {fileName: _jsxFileName, lineNumber: 44}} )
  )
));
...
(({ className, ...props }, ref) => (
  React.createElement(SelectPrimitive.ScrollDownButton, {
    ...
    , React.createElement(ChevronDown, { className: "h-4 w-4" , __self: this, __source: {fileName: _jsxFileName, lineNumber: 58}} )
  )
));
...
(({ className, children, position = "popper", ...props }, ref) => (
  React.createElement(SelectPrimitive.Portal, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 67}}
    , React.createElement(SelectPrimitive.Content, {
      ...
      , React.createElement(SelectScrollUpButton, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 79}} )
      ...
      , React.createElement(SelectScrollDownButton, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 89}} )
    )
  )
));
...
(({ className, children, ...props }, ref) => (
  React.createElement(SelectPrimitive.Item, {
    ...
    , React.createElement('span', { className: "absolute right-2 flex h-3.5 w-3.5 items-center justify-center"      , __self: this, __source: {fileName: _jsxFileName, lineNumber: 119}}
      , React.createElement(SelectPrimitive.ItemIndicator, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 120}}
        , React.createElement(Check, { className: "h-4 w-4" , __self: this, __source: {fileName: _jsxFileName, lineNumber: 121}} )
      )
    )
