...
(({ className, children, checked, ...props }, ref) => (
  React.createElement(DropdownMenuPrimitive.CheckboxItem, {
    ...
    , React.createElement('span', { className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center"      , __self: this, __source: {fileName: _jsxFileName, lineNumber: 107}}
      , React.createElement(DropdownMenuPrimitive.ItemIndicator, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 108}}
        , React.createElement(Check, { className: "h-4 w-4" , __self: this, __source: {fileName: _jsxFileName, lineNumber: 109}} )
      )
    )
    , children
  )
...
const DropdownMenuShortcut = ({ className, ...props }) => {
  return (
    React.createElement('span', { className: cn("ml-auto text-xs tracking-widest opacity-60", className), ...props, __self: this, __source: {fileName: _jsxFileName, lineNumber: 167}} )
  );
};
