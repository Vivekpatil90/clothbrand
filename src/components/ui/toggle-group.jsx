const _jsxFileName = "src/components/ui/toggle-group.tsx";"use client";
...
(({ className, variant, size, children, ...props }, ref) => (
  React.createElement(ToggleGroupPrimitive.Root, {
    ...
    , React.createElement(ToggleGroupContext.Provider, { value: { variant, size }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 25}}, children)
  )
));
