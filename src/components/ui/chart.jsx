...
(({ id, className, children, config, ...props }, ref) => {
  ...
  return (
    React.createElement(ChartContext.Provider, { value: { config }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 46}}
      , React.createElement('div', {
        ...
        , React.createElement(ChartStyle, { id: chartId, config: config, __self: this, __source: {fileName: _jsxFileName, lineNumber: 56}} )
        , React.createElement(RechartsPrimitive.ResponsiveContainer, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 57}}, children)
      )
    )
  );
});
...
(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      if (labelFormatter) {
        return (
          React.createElement('div', { className: cn("font-medium", labelClassName), __self: this, __source: {fileName: _jsxFileName, lineNumber: 141}}, labelFormatter(value, payload))
        );
      }
      ...
      return React.createElement('div', { className: cn("font-medium", labelClassName), __self: this, __source: {fileName: _jsxFileName, lineNumber: 149}}, value);
    ...
    return (
      React.createElement('div', {
        ...
        , React.createElement('div', { className: "grid gap-1.5" , __self: this, __source: {fileName: _jsxFileName, lineNumber: 167}}
          , payload
                  ...
                  , formatter && _optionalChain([item, 'optionalAccess', _10 => _10.value]) !== undefined && item.name ? (
                    ...
                    React.createElement(React.Fragment, null
                      , _optionalChain([itemConfig, 'optionalAccess', _11 => _11.icon]) ? (
                        React.createElement(itemConfig.icon, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 188}} )
                      ) : (
                        !hideIndicator && (
                          React.createElement('div', {
                            className: cn(
                      ...
                      , React.createElement('div', {
                        ...
                        , React.createElement('div', { className: "grid gap-1.5" , __self: this, __source: {fileName: _jsxFileName, lineNumber: 217}}
                          , nestLabel ? tooltipLabel : null
                          , React.createElement('span', { className: "text-muted-foreground", __self: this, __source: {fileName: _jsxFileName, lineNumber: 219}}
                            , _optionalChain([itemConfig, 'optionalAccess', _12 => _12.label]) || item.name
                          )
                        )
                        , item.value && (
                          React.createElement('span', { className: "font-mono font-medium tabular-nums text-foreground"   , __self: this, __source: {fileName: _jsxFileName, lineNumber: 224}}
          ...
          return (
            React.createElement('div', {
              ...
              , _optionalChain([itemConfig, 'optionalAccess', _14 => _14.icon]) && !hideIcon ? (
                React.createElement(itemConfig.icon, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 280}} )
              ) : (
                React.createElement('div', {
