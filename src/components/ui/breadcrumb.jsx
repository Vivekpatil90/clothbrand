...
const BreadcrumbSeparator = ({ children, className, ...props }) => (
  React.createElement('li', {
    ...
    , _nullishCoalesce(children, () => ( React.createElement(ChevronRight, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 75}} )))
  )
);
...
const BreadcrumbEllipsis = ({ className, ...props }) => (
  React.createElement('span', {
    ...
    , React.createElement(MoreHorizontal, { className: "h-4 w-4" , __self: this, __source: {fileName: _jsxFileName, lineNumber: 87}} )
    , React.createElement('span', { className: "sr-only", __self: this, __source: {fileName: _jsxFileName, lineNumber: 88}}, "More")
  )
);
