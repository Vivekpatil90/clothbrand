const _jsxFileName = "src/components/ui/dialog.tsx";"use client";
...
(({ className, children, ...props }, ref) => (
  React.createElement(DialogPortal, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 36}}
    ...
    , React.createElement(DialogPrimitive.Content, {
      ...
      , children
      , React.createElement(DialogPrimitive.Close, { className: "absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background cursor-pointer transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground"               , __self: this, __source: {fileName: _jsxFileName, lineNumber: 47}}
...
const DialogHeader = ({ className, ...props }) => (
  React.createElement('div', { className: cn("flex flex-col space-y-1.5 text-center sm:text-left", className), ...props, __self: this, __source: {fileName: _jsxFileName, lineNumber: 57}} )
);
