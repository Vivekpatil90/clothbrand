const _jsxFileName = "src/components/ui/table.tsx";import * as React from "react";
...
(({ className, ...props }, ref) => (
  React.createElement('thead', { ref: ref, className: cn("[&_tr]:border-b", className), ...props, __self: this, __source: {fileName: _jsxFileName, lineNumber: 18}} )
));
...
(({ className, ...props }, ref) => (
  React.createElement('tbody', { ref: ref, className: cn("[&_tr:last-child]:border-0", className), ...props, __self: this, __source: {fileName: _jsxFileName, lineNumber: 26}} )
));
...
(({ className, ...props }, ref) => (
  React.createElement('caption', { ref: ref, className: cn("mt-4 text-sm text-muted-foreground", className), ...props, __self: this, __source: {fileName: _jsxFileName, lineNumber: 90}} )
));
