 function _nullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return rhsFn(); } }import { createServerFn } from "@tanstack/react-start";
import { z } from "zod";
...
export const getGreeting = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data }) => {
    ...
    return {
      ...
      mode: _nullishCoalesce(config.nodeEnv, () => ( "unknown")),
    };
  });
